...
activities = {
    ...
    "Science Olympiad": {
        "description": "Compete in science competitions and explore various scientific disciplines",
    ...
    "Basketball Team": {
        "description": "Build teamwork and athletic skills through basketball practice and games",
        "schedule": "Mondays, Wednesdays, Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["jason@mergington.edu", "marcus@mergington.edu"]
    },
    "Art Club": {
    ...
    "Music Band": {
        "description": "Learn and perform music with instruments in our school band",
